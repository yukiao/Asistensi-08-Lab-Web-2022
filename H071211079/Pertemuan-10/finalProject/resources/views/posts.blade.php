  ...
  <div class="col-md-6">
    <form action="/posts">
      ...
      <div class="input-group mb-3">
        ...
        <button class="btn text-white" style="background-color: #800080;" type="submit">Search</button>
      </div>
...
<div class="card mb-3">
  ...
  <div class="card-body text-center">
    ...
    <a href="/post/{{ $posts[0]->slug }}" class="text-decoration-none btn text-white" style="background-color: #800080;">Read more</a>
      ...
      <div class="col-md-4 mb-3">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="/post/{{ $post->slug }}" class="btn text-white" style="background-color: #800080;">Read more</a>
          </div>
        </div>
      </div>
      @endforeach
