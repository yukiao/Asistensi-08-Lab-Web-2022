...
<body>
    ...
    <div class="mx-auto">
        ...
        <div class="card">
            <div class="card-header text-black" style="background-color: #FFE4E1">
                Create / Edit Data
            </div>
            <div class="card-body">
                <?php
                ...
                <form action="" method="POST">
                    ...
                    <div class="col-12">
                        <input type="submit" name="simpan" value="Simpan Data" class="btn text-white" style="background-color: #BC8F8F;" />
                    </div>
                </form>
            </div>
        </div>
