      ...
      <tbody>
        ...
        <tr>
          ...
          <td scope="row">
            ...
            <a href="/sellerPermission/edit/{{$row->id}}"><button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop-{{$row->id}}" style="color : white; background : #a9a9a9; margin-bottom:5px ">Edit</button></a>
            <a href="/sellerPermission/delete/{{$row->id}}"><button type="button" class="btn" style="color : white; background :  #686868; margin-bottom:5px">Delete</button></a>
          </td>
        </tr>
