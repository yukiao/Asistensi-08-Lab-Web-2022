            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="row">
                        ...
                        <a href="/category/edit/{{$row->id}}"><button type="button" class="btn" style="color : black; background : #FFFACD; margin-bottom:5px ">Edit</button></a>
                        <a href="/category/delete/{{$row->id}}"><button type="button" class="btn" style="color : black; background : #FAFAD2; margin-bottom:5px">Delete</button></a>
