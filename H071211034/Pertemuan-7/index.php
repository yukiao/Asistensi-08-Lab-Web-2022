...
<body>
  <a href="logout.php"><button type="button" class="btn btn-danger m-2">Keluar</button></a>
  <div class="mx-auto">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?php
          header("refresh:15;url=index.php"); //refresh dalam 15 : detik
        }
        ?>
        <?php
        if ($sukses) {
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="fakultas" id="fakultas">
                ...
                <option value="Ekonomi Bisnis" <?php if ($fakultas == "Ekonomi Bisnis") echo "selected" ?>>Ekonomi
                  Bisnis</option>
                <option value="Hukum" <?php if ($fakultas == "Hukum") echo "selected" ?>>Hukum</option>
                <option value="Ilmu Sosial Politik" <?php if ($fakultas == "Ilmu Sosial Politik") echo "selected" ?>>
                  Ilmu Sosial Politik</option>
                <option value="Ilmu Budaya" <?php if ($fakultas == "Ilmu Budaya") echo "selected" ?>>Ilmu Budaya
                </option>
                <option value="Kedokteran" <?php if ($fakultas == "Kedokteran") echo "selected" ?>>Kedokteran</option>
                <option value="Kedokteran Gigi" <?php if ($fakultas == "Kedokteran Gigi") echo "selected" ?>>Kedokteran
                  Gigi</option>
                <option value="Kesehatan Masyarakat" <?php if ($fakultas == "Kesehatan Masyarakat") echo "selected" ?>>
                  Kesehatan Masyarakat</option>
                <option value="Farmasi" <?php if ($fakultas == "Farmasi") echo "selected" ?>>Farmasi</option>
                <option value="Keperawatan" <?php if ($fakultas == "Keperawatan") echo "selected" ?>>Keperawatan
                </option>
                ...
                <option value="Ilmu Kelautan dan Perikanan"
                  <?php if ($fakultas == "Ilmu Kelautan dan Perikanan") echo "selected" ?>>Ilmu Kelautan dan Perikanan
                </option>
            ...
            <tr>
              ...
              <td scope="row">
                ...
                <a href="index.php?op=delete&id=<?php echo $id ?>"
                  onclick="return confirm('Apakah Anda Yakin Mau Menghapus Data Ini?')"><button type="button"
