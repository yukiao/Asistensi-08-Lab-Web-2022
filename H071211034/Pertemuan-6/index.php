...
if($op == 'delete'){
    $id         = $_GET['id'];
    $sql1       = "delete from sisfo2021 where id = '$id'";
...
if ($op == 'edit') {
    $id         = $_GET['id'];
    $sql1       = "select * from sisfo2021 where id = '$id'";
    $q1         = mysqli_query($conn, $sql1);
...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nim && $nama && $alamat && $fakultas) {
        if ($op == 'edit') {
            $sql1       = "update sisfo2021 set nim = '$nim',nama='$nama',alamat = '$alamat',fakultas='$fakultas' where id = '$id'";
            $q1         = mysqli_query($conn, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into sisfo2021(nim,nama,alamat,fakultas) values ('$nim','$nama','$alamat','$fakultas')";
            $q1     = mysqli_query($conn, $sql1);
            if ($q1) {
    ...
    <div class="card">
      ...
      <div class="card-body">
        <table class="table">
          ...
          <tbody>
            <?php
            $sql2   = "select * from sisfo2021 order by id desc";
