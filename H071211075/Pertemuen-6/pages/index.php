...
if ($koneksi->query($sql3) === TRUE) {
    ...
    echo "Error: " . $sql3 . "<br>" . $koneksi->error;
}
$koneksi -> close();
...
if ($koneksi->query($sql4) === TRUE) {
    ...
    echo "Error: " . $sql4 . "<br>" . $koneksi->error;
}
$nim        = "";
$nama       = "";
$alamat     = "";
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="fakultas" id="fakultas">
                                ...
                                <option value="FMIPA" <?php if ($fakultas == "MIPA") echo "selected" ?>>MIPA</option>
                                <option value="FK" <?php if ($fakultas == "FK") echo "selected" ?>>FK</option>
                                <option value="FT" <?php if ($fakultas == "FT") echo "selected" ?>>FT</option>
                                <option value="FISIPOL" <?php if ($fakultas == "FISIPOL") echo "selected" ?>>FISIPOL</option>
                                ...
                                <option value="FAPET" <?php if ($fakultas == "FAPET") echo "selected" ?>>FAPET</option>
