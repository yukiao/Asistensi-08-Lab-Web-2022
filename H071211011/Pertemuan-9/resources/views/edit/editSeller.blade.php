    ...
    <div class="card-body">
      <form action="/seller/update/{{$singleData->id}}" method="POST">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="address" name="address" value="{{$singleData->address}}" required>
          </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="number" class="form-control" id="no_hp" name="no_hp" value="{{$singleData->no_hp}}" required>
          </div>
        </div>
        <div class="mb-3 row">
