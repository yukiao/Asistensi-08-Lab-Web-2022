      ...
      <tbody>
        ...
        <tr>
          ...
          <td scope="row">
            ...
            <a href="/category/edit/{{$item->id}}"><button type="button" class="btn" style="color : white; background : #a9a9a9; border-radius: 15px; margin-bottom:5px ">Edit</button></a>
            <a href="/category/delete/{{$item->id}}"><button type="button" class="btn" style="color : white; background : #686868; border-radius: 15px; margin-bottom:5px">Delete</button></a>
