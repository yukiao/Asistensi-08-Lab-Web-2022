        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div class="modal-content">
            ...
            <div class="bg-dark modal-footer">
              <button type="submit" name="submit" class="btn btn-primary add_tag">Save</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-10">
            ...
            <div class="card bg-dark text-white">
                <div class="card-body mt-3">
                    <div class="card-title text-center h3 mt-2">Tags List</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('tags.destroy', $item->id) }}"method="POST">
                                        <a class="btn btn-warning" href="{{ route('tags.edit', $item->id) }}">Edit</a>
                                        @csrf
                                        @method('DELETE')
                    ...
                    <div class="d-flex justify-content-end pt-2 pb-1">
                        <a href="" class='btn btn-success' data-bs-toggle="modal" data-bs-target="#addTagModal">+ Add</a>
                    </div>
                    @endcan
                </div>
            </div>
