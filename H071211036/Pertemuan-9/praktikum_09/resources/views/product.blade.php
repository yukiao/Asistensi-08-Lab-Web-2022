...
<div class="card">
  ...
  <div class="card-body">
    ...
    <table class="table table-striped" style="background : #F0E68C;">
      <thead>
        <tr>
          <th scope="col">No</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td scope="row">
            ...
            <a href="/product/edit/{{$row->id}}"><button type="button" class="btn" style="color : white; background : #FFFACD; margin-bottom:5px ">Edit</button></a>
            <a href="/product/delete/{{$row->id}}"><button type="button" class="btn" style="color : white; background : #FAFAD2; margin-bottom:5px">Delete</button></a>
          </td>
        </tr>
        @endforeach
      </tbody>
