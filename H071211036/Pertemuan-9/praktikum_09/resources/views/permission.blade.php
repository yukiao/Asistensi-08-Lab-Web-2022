    ...
    <table class="table table-striped" style="background-color: #F0E68C;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td scope="row">
            <a href="/permission/edit/{{$row->id}}"><button type="button" class="btn" style="color : white; background : #FFFACD; margin-bottom:5px ">Edit</button></a>
            <a href="/permission/delete/{{$row->id}}"><button type="button" class="btn" style="color : white; background : #FAFAD2; margin-bottom:5px">Delete</button></a>
          </td>
        </tr>
        @endforeach
      </tbody>
