...
<!-- INSERT DATA -->
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <select class="form-control" name="fakultas" id="fakultas">
                            ...
                            <option value="Fakultas Ekonomi dan Bisnis" <?php if($fakultas == "FEB") echo "selected" ?>>Fakultas Ekonomi dan Bisnis</option>
                            <option value="Fakultas Hukum" <?php if($fakultas == "FH") echo "selected" ?>>Fakultas Hukum</option>
                            <option value="Fakultas Kedokteran" <?php if($fakultas == "FK") echo "selected" ?>>Fakultas Kedokteran</option>
                            <option value="Fakultas Teknik" <?php if($fakultas == "FT") echo "selected" ?>>Fakultas Teknik</option>
                            <option value="Fakultas Ilmu Sosial dan Ilmu Politik" <?php if($fakultas == "FISIP") echo "selected" ?>>Fakultas Ilmu Sosial dan Ilmu Politik</option>
                            <option value="Fakultas Ilmu Budaya" <?php if($fakultas == "FIB") echo "selected" ?>>Fakultas Ilmu Budaya</option>
                            <option value="Fakultas Pertanian" <?php if($fakultas == "FP") echo "selected" ?>>Fakultas Pertanian</option>
                            <option value="Fakultas Matematika dan Ilmu Pengetahuan Alam" <?php if($fakultas == "FMIPA") echo "selected" ?>>Fakultas Matematika dan Ilmu Pengetahuan Alam</option>
                            <option value="Fakultas Peternakan" <?php if($fakultas == "FPET") echo "selected" ?>>Fakultas Peternakan</option>
                            <option value="Fakultas Kedokteran Gigi" <?php if($fakultas == "FKG") echo "selected" ?>>Fakultas Kedokteran Gigi</option>
                            <option value="Fakultas Kesehatan Masyarakat" <?php if($fakultas == "FKM") echo "selected" ?>>Fakultas Kesehatan Masyarakat</option>
                            <option value="Fakultas Ilmu Kelautan dan Perikanan" <?php if($fakultas == "FIKP") echo "selected" ?>>Fakultas Ilmu Kelautan dan Perikanan</option>
                            <option value="Fakultas Kehutanan" <?php if($fakultas == "FAHUT") echo "selected" ?>>Fakultas Kehutanan</option>
                            <option value="Fakultas Farmasi" <?php if($fakultas == "FF") echo "selected" ?>>Fakultas Farmasi</option>
                            <option value="Fakultas Keperawatan" <?php if($fakultas == "FIK") echo "selected" ?>>Fakultas Keperawatan</option>
                            <option value="Sekolah Pascasarjana" <?php if($fakultas == "SPS") echo "selected" ?>>Sekolah Pascasarjana</option>
                        </select>
                        </div>
    ...
    <br>
    <center><a href="logout.php" style="color: #7c8fa0;">Logout</a></center>
</body>
