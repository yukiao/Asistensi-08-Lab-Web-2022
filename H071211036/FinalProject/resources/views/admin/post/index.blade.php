...
@section('content')
    ...
    <a href="/post/create" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add Post</a>
                ...
                @foreach ($post as $row)
                    ...
                    <td width="35%">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <a href="/post/{{$row->id}}/konfirmasi" class="btn btn-danger btn-sm mr-1"><i class="fas fa-trash"></i> Delete</a>
                        </div>
                    </td>
                    </tr>
                @endforeach
