...
@section('content')
    ...
    <a href="/banner/create" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add Banner</a>
                ...
                @foreach ($banner as $row)
                    ...
                    <td width="25%">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <a href="/banner/{{$row->id}}/konfirmasi" class="btn btn-danger btn-sm mr-1"><i class="fas fa-trash"></i> Delete</a>
                        </div>
                    </td>
                    </tr>
                @endforeach
