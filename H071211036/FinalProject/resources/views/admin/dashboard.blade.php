...
@section('content')
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
            <div class="col mr-2">
                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Tag</div>
                <div class="row no-gutters align-items-center">
                <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
            <div class="col mr-2">
                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Banner</div>
    ...
    <div class="card border-bottom-primary">
        ...
        <h6 class="m-0 font-weight-bold text-primary">Today's Post</h6>
        </div>
        <div class="card-body">
           @if ($post->count() >= 1)
           ...
           @else
               ...
               You dont have any new post today
                </div>
           @endif
        </div>
    </div>
    ...
    <div class="card border-bottom-success mt-4">
        <div class="card-header">
        <h6 class="m-0 font-weight-bold text-success">Today's Category</h6>
        </div>
        <div class="card-body">
           @if ($kategori->count() >= 1)
                <table class="table table-hover table-bordered">
           ...
           @else
                <div class="alert alert-info" role="alert">
                You dont have any new category today
                </div>
           @endif
        </div>
   </div>
    ...
    <div class="card border-bottom-info mt-4">
        <div class="card-header">
        <h6 class="m-0 font-weight-bold text-info">Today's Tag</h6>
        </div>
        <div class="card-body">
           @if ($tag->count() >= 1)
                <table class="table table-hover table-bordered">
           ...
           @else
                <div class="alert alert-info" role="alert">
                You dont have any new tag today
                </div>
           @endif
        </div>
   </div>
    ...
    <div class="card border-bottom-warning mt-4">
        <div class="card-header">
        <h6 class="m-0 font-weight-bold text-warning">Today's Banner</h6>
        </div>
        <div class="card-body">
           @if ($banner->count() >= 1)
                <table class="table table-hover table-bordered">
           ...
           @else
                <div class="alert alert-info" role="alert">
                You dont have any new banner today
                </div>
           @endif
        </div>
   </div>
